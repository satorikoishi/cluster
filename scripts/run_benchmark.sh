...
kubectl cp -n $NAMESPACE -c $TRIGGER_CONTAINER_NAME $POD_NAME:/hydro/cloudburst/latency.csv ./detailed_latency.csv
kubectl cp -n $NAMESPACE -c $TRIGGER_CONTAINER_NAME $POD_NAME:/hydro/cloudburst/exec_latency.csv ./exec_latency.csv
kubectl cp -n $NAMESPACE -c $TRIGGER_CONTAINER_NAME $POD_NAME:/hydro/cloudburst/exec_latency.csv ./exec_detailed_latency.csv
