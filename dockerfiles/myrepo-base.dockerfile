...
RUN git clone --recurse-submodules https://github.com/satorikoishi/anna-cache
RUN git clone --recurse-submodules https://github.com/satorikoishi/cloudburst
RUN git clone --recurse-submodules https://github.com/satorikoishi/cluster
